...
| **P2: Central Dogma** | 10 or more out of 13 tests pass | 6-9 tests pass | Fewer than 6 tests pass or you do not submit the assignment |
...
Share something you learned in a short (10-15 minutes) presentation during the finals week slot. You can talk about anything pertaining to class, in any way you would like (as long as it fills the expected presentation length). You will meet with me to discuss your plan to make sure this CYO assignment has the appropriate scope. Note that all students are expected to attend the presentations, but only students who decided to do this CYO assignment will present.
